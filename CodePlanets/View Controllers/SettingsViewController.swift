...
class SettingsViewController: UIViewController {
    ...
    private func setUpSubviews() {
        ...
        let doneButtonTopContstaint = doneButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 20)
        ...
        let switchTrailingConstaint = shouldShowPlutoSwitch.trailingAnchor.constraint(equalTo: doneButton.trailingAnchor)
        ...
        let labelCenterYContraint = label.centerYAnchor.constraint(equalTo: shouldShowPlutoSwitch.centerYAnchor)
        
        // All
        // 4. Activate constraints
        NSLayoutConstraint.activate([doneButtonTopContstaint,
                                     doneButtonTrailingConstraint,
                                     switchTopConstraint,
                                     switchTrailingConstaint,
                                     labelLeading,
                                     labelCenterYContraint])
